        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="text-center mt-4">Sub Bagian Pendidikan</h2>
                            <hr class="" />
                            <img src={{ asset('assets/img/avatar.jpg') }} alt="Avatar" class="image" height="300px">
                            <h4 class="text-black font-weight-bold pt-4">ARIF HUSNI, S.Kom</h4>
                            <h5 class="text-black font-weight-bold">Analis Kebijakan Ahli Muda</h5>
                            <h5 class="text-black font-weight-bold">Selaku</h5>
                            <h5 class="text-black font-weight-bold">Sub Koordinator Pendidikan</h5>
                            <hr class="" />
                            <h5 class="text-black font-weight-bold">Tugas Sub Bagian Pendidikan</5>
                            <h5 class="text-black font-weight-bold">(Pasal 67) </h5>
                            ...
                            <p class="text-black font-weight-bold">Melakukan
                                penyiapan bahan pengoordinasian penyusunan dan analisis kebijakan Daerah,
                                pengoordinasian pelaksanaan tugas Perangkat Daerah, penyiapan bahan
                                pengoordinasian pelaksanaan tugas Perangkat Gubernur bidang Pendidikan,
                                Kebudayaan dan Perpustakaan pemantauan dan evaluasi pelaksanaan
                                kebijakan Daerah, pelayanan adrninistratif dan pembinaan sumber daya ASN
                                di bidang pendidikan, kebudayaan dan perpustakaan.</p>
                            <hr class="" />
                            <h4 class="text-black font-weight-bold pt-4">Meliputi :</h4>
                            <p class="text-black font-weight-bold">Menyiapkan bahan pengoordiansian penyusunan dan analisis kebijakan
                                Daerah di bidang pendidikan, kebudayaan dan perpustakaan</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan penyusunan data di bidang pendidikan, kebudayaan
                                dan perpustakaan;</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan pengoordinasian pelaksanaan tugas Perangkat Daerah
                                di bidang pendidikan, sarana pendidikan agama, pendidikan keagamaan
                                kebudayaan dan perpustakaan</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan pertimbangan pemberian bantuan di bidang
                                pendidikan, kebudayaan dan perpustakaan</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan pengoordinasian pelaksanaan tugas Perangkat
                                Gubemur bidang Pendidikan, Kebudayaan dan Perpustakaan</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan monitoring, evaluasi dan pelaporan kebijakan Daerah di
                                bidang pendidikan, kebudayaan dan perpustakaan</p>
