        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="text-center mt-4">Sub Bagian Pelayanan Kehidupan Beragama</h2>
                            <hr class="" />
                            <img src={{ asset('assets/img/avatar.jpg') }} alt="Avatar" class="image" height="300px">
                            <h4 class="text-black font-weight-bold pt-4">n/a</h4>
                            <h5 class="text-black font-weight-bold">Analis Kebijakan Ahli Muda</h5>
                            <h5 class="text-black font-weight-bold">Selaku</h5>
                            <h5 class="text-black font-weight-bold">Sub Koordinator Pelayanan Kehidupan Beragama</h5>
                            <hr class="" />
                            <h5 class="text-black font-weight-bold">Tugas Sub Bagian Pelayanan Kehidupan Beragama</h5>
                            <h5 class="text-black font-weight-bold">(Pasal 61)</h5>
                            ...
                            <p class="text-black font-weight-bold">Melakukan penyiapan bahan
                                ...
                                pelaksanaan tugas Perangkat Gubernur bidang Pelayanan Kehidupan
                                Beragama, pemantauan dan evaluasi pelaksanaan kebijakan Daerah,
                                pelayanan administratif dan pembinaan sumber daya ASN di bidang pelayanan
