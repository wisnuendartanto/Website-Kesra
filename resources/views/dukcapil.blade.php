        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="text-center mt-4">Sub Bagian Pemberdayaan Masyarakat Desa Kependudukan dan Pencatatan Sipil</h2>
                            <hr class="" />
                            <img src={{ asset('assets/img/avatar.jpg') }} alt="Avatar" class="image" height="300px">
                            <h4 class="text-black font-weight-bold pt-4">ENY SURYANI, S.Pd, M.Dev, Plg</h4>
                            <h5 class="text-black font-weight-bold">Analis Kebijakan Ahli Muda</h5>
                            <h5 class="text-black font-weight-bold">Selaku</h5>
                            <h5 class="text-black font-weight-bold">Sub Koordinator Pemberdayaan Masyarakat Desa Kependudukan dan Pencatatan Sipil</h5>
                            <hr class="" />
                            <h5 class="text-black font-weight-bold">Tugas Sub Bagian Pemberdayaan Masyarakat Desa Kependudukan dan Pencatatan Sipil</h5>
                            <h5 class="text-black font-weight-bold">(Pasal 74)</h5>
                            ...
                            <p class="text-black font-weight-bold">Melakukan penyiapan bahan pengoordinasian penyusunan dan analisis
...
pengoordinasian pelaksanaan tugas Perangkat Gubemur bidang
Pemberdayaan Masyarakat Desa, Kependudukan Dan Catalan Sipil, pelayanan
administratif dan pembinaan sumber daya ASN di bidang subbagian
pemberdayaan masyarakat desa, kependudukan dan catatan sipil. 

                                </p>
                            <hr class="" />
                            <h4 class="text-black font-weight-bold pt-4">Meliputi :</h4>
                            <p class="text-black font-weight-bold">Menyiapkan bahan pengoordinasian perumusan kebijakan Daerah di
bidang pemberdayaan masyarakat desa, kependudukan dan catatan sipil</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan penyusunan data di bidang pemberdayaan masyarakat
desa, kependudukan dan catatan sipil</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan pengoordinasian pelaksanaan tugas Perangkat Daerah
di bidang pemberdayaan masyarakat desa, kependudukan dan catatan
sipil</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan pengoordinasian pelaksanaan tugas Perangkat
Gubemur bidang Pemberdayaan Masyarakat Desa, Kependudukan Dan
Catatan Sipil</p>
                            <p class="text-black font-weight-bold">Menyiapkan bahan pertimbangan pemberian bantuan di bidang
pemberdayaan masyarakat desa, kependudukan dan catatan sipil</p>
...
bidang pemberdayaan masyarakat desa, kependudukan dan catatan sipil</p>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="card pt-2">
                        <a class="twitter-timeline" data-height="900"
