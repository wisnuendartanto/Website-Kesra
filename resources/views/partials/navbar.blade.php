                    ...
                    <a class="nav-link {{ Request::route()->getPrefix() == '/kegiatan' ? 'active' : '' }} dropdown-toggle"
                      ...
                      <a class="nav-link {{ Request::route()->getPrefix() == '/kegiatan' ? 'active' : '' }} dropdown-toggle"
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li class="nav-item dropdown">
                      <a class="nav-link {{ Request::route()->getPrefix() == '/Pengumuman' ? 'active' : '' }} dropdown-toggle"
                          data-bs-toggle="dropdown" href="/post" role="button" aria-expanded="false">Pengumuman</a>
                        <ul class="dropdown-menu">
